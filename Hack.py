#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#Apaan morecode?merecode tidak bisa  menjadikan anda mastah ^_^
...
def banner():
    ...
    print ('')                                                 
    print (G+'##########################################')
    print (G+'############'+P+'[BRUTE FB CRACKED]'+G+'############')
    print (G+'##########################################')
    print (G+'###'+B+'Created by:'+O+'Light-ID'+G+'####################')
    print (G+'###'+B+'My Team:'+O+'WarceuRootCyber'+G+'################')
    print (G+'###'+B+'Whatsapp:'+O+'083876915082'+G+'##################')
    print (G+'###'+B+'Facebook:'+O+'Wong Kang Edzan'+G+'###############')
    print (G+'##########################################')
    print (G+'#############'+P+'copyright:2020'+G+'###############') 
    print (G+'##########################################')
    print ('')                                                  
